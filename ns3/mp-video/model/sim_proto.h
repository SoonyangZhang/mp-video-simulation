...
//SIM_TRANSPORT_NACK, if their is gap between I frame seg
//sent ack immediately
#define protocol_ver			0x01
//the value var could used for session id;
// uid could be used similar as quic  cid;
// odd(1,3,5...)for caller , even(2,4,6...) for callee.
typedef struct
{
