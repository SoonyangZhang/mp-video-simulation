#ifndef NS3_MPVIDEO_CONGESTION_BBR_SENDER_V4_H_
#define NS3_MPVIDEO_CONGESTION_BBR_SENDER_V4_H_
...
namespace quic{
class MyBbrSenderV4:public BandwidthEstimateInteface,
...
public:
	...
	MyBbrSenderV4(uint64_t min_bps,BandwidthObserver *observer);
	~MyBbrSenderV4();
