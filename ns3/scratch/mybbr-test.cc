...
int main(int argc, char *argv[])
{
	...
	uint64_t linkBw   = 5000000;//4000000;
    ...
    std::string log_name_1=instance+std::string("-mybbr-1");
    ...
    std::string log_name_2=instance+std::string("-mybbr-2");
    ...
    std::string log_name_3=instance+std::string("-mybbr-3");
    ...
    */
    ...
    std::string log_name_4=instance+std::string("-mybbr-4");
    ...
    InstallTcp(nodes.Get(0),nodes.Get(1),4444,50,200);
